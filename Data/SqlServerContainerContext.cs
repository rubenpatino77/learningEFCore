...
public partial class SqlServerContainerContext : DbContext
{
    public SqlServerContainerContext()
    {
    }

    public SqlServerContainerContext(DbContextOptions<SqlServerContainerContext> options)
        : base(options)
    {
    }
